...
class Scenario(BaseScenario):
    ...
    def make_world(self):
        ...
        for i, agent in enumerate(world.agents):
            ...
            # agent.max_vision = 0.4
            agent.value_outvision = 1
    ...
    def benchmark_data(self, agent, world):
        ...
        is_success = np.all(self.delta_dists < self.dist_thres)
        if is_success:
            is_success = 1
        else:
            is_success = 0
        ...
        return self.joint_reward, self.delta_dists.mean(), is_success, landmark_pos
